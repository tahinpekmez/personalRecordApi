package notebookManagement.controller;
...
public class NoteBookController {
    ...
    public ResponseEntity getnotebooks(@Parameter(description = "Page index (start from 0)") @RequestParam(value = "page") Integer page, @Parameter(description = "Number of records per page") @RequestParam(value = "pageSize") Integer pageSize) {
    ...
    public ResponseEntity getnotebookById(@Parameter(description = "id of notebook to be retrieved")  @PathVariable int notebookId){
    ...
    public ResponseEntity updatenotebook(@Parameter(description = "id of notebook to be updated")  @PathVariable int notebookId, @Parameter(description = "notebook updated information")  @RequestBody NoteBook notebook){
    ...
    public ResponseEntity deletenotebook(@Parameter(description = "id of notebook to be deleted")  @PathVariable int notebookId){
        ...
        public ResponseEntity handleUserInputException() {
